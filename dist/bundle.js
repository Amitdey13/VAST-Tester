...
/* harmony import */ var _toJSON__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./toJSON */ "./src/toJSON.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
document.addEventListener('DOMContentLoaded', function () {
  var form = document.getElementById('vastForm');
  var logOutput = document.getElementById('logOutput');
  form.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
      var vastUrl, loader, wrapperVasts, wrappers, inLineVast, inLine, linear, events, jsonEvents, jsonVast, jsonLinear, mediaFile, visualAudioAddSlot, divElement, audioElement, playBtn, viceoEle;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            wrapperVasts = loader.slice(0, loader.length - 1);
            wrappers = wrapperVasts.map(getAdFromVast('Wrapper', warn));
            inLineVast = loader[loader.length - 1];
            inLine = getAdFromVast('InLine', warn)(inLineVast);
            linear = getLinearFromInLine(inLine, warn);
            events = getTrackingEventsFromLinear(linear);
            jsonEvents = (0,_toJSON__WEBPACK_IMPORTED_MODULE_1__["default"])(getTrackingEventsFromLinear(linear));
            jsonVast = (0,_toJSON__WEBPACK_IMPORTED_MODULE_1__["default"])(loader);
            jsonInline = (0,_toJSON__WEBPACK_IMPORTED_MODULE_1__["default"])(inLine);
            jsonLinear = (0,_toJSON__WEBPACK_IMPORTED_MODULE_1__["default"])(linear);
            mediaFile = jsonLinear.mediaFiles[0]; // console.log(jsonVast);
            console.log({
              jsonInline: jsonInline
            });
            // console.log(events);
            visualAudioAddSlot = document.getElementById('visualAudioAddSlot');
            if (mediaFile.type.includes('audio')) {
              ...
              viceoEle = createVideoElement(mediaFile);
...
function logEvents(type, url) {
  var logList = document.getElementById("visualLog");
  var logEle = document.createElement('li');
  logEle.innerHTML = "Event: ".concat(type);
  var logEleUrl = document.createElement('li');
  logEle.innerHTML = "".concat(type, ": ").concat(url);
  fetch(url);
...
var getAdFromVast = function getAdFromVast(type, warn) {
  return function (vast) {
    if (vast.version >= '4.0') {
...
var getLinearFromInLine = function getLinearFromInLine(inLine, warn) {
...
var getTrackingEventsFromLinear = function getTrackingEventsFromLinear(linear) {
...
var createVideoElement = function createVideoElement(mediaFile) {
  var divElement = document.createElement('div');
  divElement.className = "visual-audio-video-container";
  divElement.style.width = "".concat(mediaFile.width, "px");
  divElement.style.height = "".concat(mediaFile.height, "px");
  ...
  divElement.appendChild(playBtn);
  var impression = jsonInline.impressions[0];
